...
# TODO: Refactor ec2, rds, s3 as inner classes
class AWS:
    def __init__(self):
    ...
    def ec2StopInstance(self, instance_id):
    ...
    def ec2StartInstance(self, instance_id):
    ...
    def ec2CreateInstance(self, user_data_script=None, ami_id=cst.AMI_ID, subnet_id=cst.SUBNET_ID1, key_name=cst.KEY_NAME):
    ...
    def ec2Modify(self, instance_id, security_group_id=cst.SECURITY_GROUP_ID, instance_profile=cst.INSTANCE_PROFILE):
        try:
    ...
    def ec2Terminate(self, instance_id):
    ...
    def rdsReadInstance(self, instance_id):
    ...
    def rdsDeleteInstance(self, db_subnet_group_name, instance_id='db5102-public'):
    ...
    def rdsCreate(self, subnet_ids=[cst.SUBNET_ID1, cst.SUBNET_ID2], security_group_id_rds=cst.SECURITY_GROUP_ID_RDS):
    ...
    def rdsCreateTable(self, endpoint, port=5432):
    ...
    def rdsUpdateTable(self, table_name, endpoint, port=5432):
    ...
    def rdsReadTable(self, table_name, endpoint, port=5432):
        connection_str = f"postgresql://{DB_USER}:{DB_PASSWORD}@{endpoint}:{port}/{DB_NAME}"
