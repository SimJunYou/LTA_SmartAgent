...
class RainfallData:
    """
    The module will download rainfall readings from the specified API into the current working dir.
    Call download_local method with an output file name to append the data.
    """

    def __init__(self):
        self.api_url = "https://api.data.gov.sg/v1/environment/rainfall"
        self.s3 = AWS().s3
    ...
    def download_local(self, date_time, output_file="rainfall.csv"):
        ...
        if data and 'items' in data and data['items']:
            ...
            } for reading in data['items'][0]['readings'] if station_info[reading['station_id']]['name'] != reading['station_id']
        ]
